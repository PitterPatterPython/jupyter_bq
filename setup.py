...
integration_str = "bq" # This could change to oracle, drill, elastic etc.
...
setup_args = dict(
    ...
    long_description="A magic function for working with Big Query for Python3 based Jupyter Notebooks",
    author="John Omernik",
